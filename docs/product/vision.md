...
3. **v3 — Web + reach:** first-class Apple Music web access for listeners who cannot or choose not to use the native iOS app (sync, mix creation, playback, playlist conversion, and browse; no native play counts), App Store release, Sign in with Apple polish, licensed lyrics deal when revenue justifies.
